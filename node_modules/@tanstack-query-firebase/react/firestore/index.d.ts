...
import { Firestore, FirestoreError, Transaction, TransactionOptions, WriteBatch, DocumentData, DocumentReference, DocumentSnapshot, Query, QuerySnapshot, AggregateSpec, AggregateQuerySnapshot, AggregateField, CollectionReference, WithFieldValue, UpdateData } from 'firebase/firestore';
...
type FirestoreUseMutationOptions$7<TData = unknown, TError = Error> = Omit<UseMutationOptions<TData, TError, void>, "mutationFn">;
declare function useDisableNetworkMutation(firestore: Firestore, options?: FirestoreUseMutationOptions$7<void, FirestoreError>): _tanstack_react_query.UseMutationResult<void, FirestoreError, void, unknown>;

type FirestoreUseMutationOptions$6<TData = unknown, TError = Error> = Omit<UseMutationOptions<TData, TError, void>, "mutationFn">;
declare function useEnableNetworkMutation(firestore: Firestore, options?: FirestoreUseMutationOptions$6<void, FirestoreError>): _tanstack_react_query.UseMutationResult<void, FirestoreError, void, unknown>;
...
type FirestoreUseMutationOptions$5<TData = unknown, TError = Error> = Omit<UseMutationOptions<TData, TError, void>, "mutationFn"> & {
    firestore?: TransactionOptions;
};
declare function useRunTransactionMutation<T>(firestore: Firestore, updateFunction: RunTransactionFunction<T>, options?: FirestoreUseMutationOptions$5<T>): _tanstack_react_query.UseMutationResult<T, FirestoreError, void, unknown>;

type FirestoreUseMutationOptions$4<TError = Error> = Omit<UseMutationOptions<void, TError, WriteBatch>, "mutationFn">;
declare function useWriteBatchCommitMutation(options?: FirestoreUseMutationOptions$4<FirestoreError>): _tanstack_react_query.UseMutationResult<void, FirestoreError, WriteBatch, unknown>;
...
type FirestoreUseMutationOptions$3<TData = unknown, TError = Error, AppModelType extends DocumentData = DocumentData> = Omit<UseMutationOptions<TData, TError, WithFieldValue<AppModelType>>, "mutationFn">;
declare function useAddDocumentMutation<AppModelType extends DocumentData = DocumentData, DbModelType extends DocumentData = DocumentData>(collectionRef: CollectionReference<AppModelType, DbModelType>, options?: FirestoreUseMutationOptions$3<DocumentReference<AppModelType, DbModelType>, FirestoreError, AppModelType>): _tanstack_react_query.UseMutationResult<DocumentReference<AppModelType, DbModelType>, FirestoreError, WithFieldValue<AppModelType>, unknown>;

type FirestoreUseMutationOptions$2<TData = unknown, TError = Error, DbModelType extends DocumentData = DocumentData> = Omit<UseMutationOptions<TData, TError, UpdateData<DbModelType>>, "mutationFn">;
declare function useUpdateDocumentMutation<AppModelType extends DocumentData = DocumentData, DbModelType extends DocumentData = DocumentData>(documentRef: DocumentReference<AppModelType, DbModelType>, options?: FirestoreUseMutationOptions$2<void, FirestoreError, DbModelType>): _tanstack_react_query.UseMutationResult<void, FirestoreError, UpdateData<DbModelType>, unknown>;

type FirestoreUseMutationOptions$1<TData = unknown, TError = Error, AppModelType extends DocumentData = DocumentData> = Omit<UseMutationOptions<TData, TError, WithFieldValue<AppModelType>>, "mutationFn">;
declare function useSetDocumentMutation<AppModelType extends DocumentData = DocumentData, DbModelType extends DocumentData = DocumentData>(documentRef: DocumentReference<AppModelType, DbModelType>, options?: FirestoreUseMutationOptions$1<void, FirestoreError, AppModelType>): _tanstack_react_query.UseMutationResult<void, FirestoreError, WithFieldValue<AppModelType>, unknown>;
