    ...
    <div className="border-b border-border sm:border-b-0">
      <div className="py-4 sm:p-4">
        ...
        <div className="flex items-center gap-1">
          ...
          <Link to={`/post/${post.id}`} className="flex items-center gap-1.5 text-xs font-medium text-muted-foreground hover:bg-secondary px-2 py-1 rounded-sm transition-colors duration-150">
